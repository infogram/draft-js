...
function editOnPaste(editor, e) {
  ...
  if (!data.isRichText()) {
    ...
    if (files.length > 0) {
      ...
      fileText) {
        ...
        var text = DraftPasteProcessor.processText(blocks, character, currentBlock.getType(), currentBlock.getData());
  ...
  if (textBlocks.length) {
    ...
    var textFragment = DraftPasteProcessor.processText(textBlocks, character, currentBlock.getType(), currentBlock.getData());
